                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AnimatedEntityButton(text: l10n.register, colors: [primaryCyan, primaryPurple], onPressed: () { if (_formKey.currentState!.validate()) { globalComboIndex.value = _localSelectedCombo; Navigator.pushAndRemoveUntil(context, EntityPageRoute(page: const MainScreen()), (r) => false); } }),
